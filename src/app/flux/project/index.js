...
export const actions = {
    ...
    autoSaveEnvironment: (headType, force = false) => async (dispatch, getState) => {
        ...
        if (lastString) {
            Object.entries(JSON.parse(lastString)).forEach(([key, value]) => {
                console.log('d', key, value, envObj[key]);
            });
        }
        console.log('openedFile dddd', Boolean(lastString), content !== lastString);
