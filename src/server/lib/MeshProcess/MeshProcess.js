...
export class MeshProcess {
    ...
    convertToStackFiles(modelCuttingSettings) {
        ...
        let { width, height, extend } = modelCuttingSettings;
        extend += 3;
        ...
        for (let i = 0; i < this.slicer.slicerLayers.length; i++) {
            ...
            svgFileState.svg.shapes[0].paths.push({
                points: [[svgFileState.startX + 3, svgFileState.startY + 3], [svgFileState.startX + boundingBoxX - 3, svgFileState.startY + 3],
                    [svgFileState.startX + boundingBoxX - 3, svgFileState.startY + boundingBoxY - 3],
                    [svgFileState.startX + 3, svgFileState.startY + boundingBoxY - 3], [svgFileState.startX + 3, svgFileState.startY + 3]]
            });
